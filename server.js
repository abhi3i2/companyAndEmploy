...
let Employee = require('./backEnd/routes/employee/employeeRoutes');
...
app.use(express.static(path.join(__dirname, '/dist/companyProject')));


//This is the static file for Angular 6
 //app.use(express.static(__dirname, '/dist/companyProject'));
...
//Default Route
app.get('*', function (req, res, next) {
    res.sendFile(path.join(__dirname, 'dist/companyProject/index.html'));
})
